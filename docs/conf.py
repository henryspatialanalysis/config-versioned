...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/henryspatialanalysis/config-versioned/",
            "html": (
                ...
                "28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2."
                "15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27"
                ...
                " henryspatialanalysis/config-versioned"
            ),
            "class": "",
        },
    ],
